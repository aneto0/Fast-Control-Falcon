...
| SDNPub | [SDNPublisher](https://vcis-gitlab.f4e.europa.eu/aneto/MARTe2-components/blob/develop/Source/Components/DataSources/SDN/SDNPublisher.h) | Publishes data into the SDN network | **Topic** = FalconFast //*Name of the topic* <br/> **Interface** = eth3 //*Name of the interface publishing the SDN traffic* |
